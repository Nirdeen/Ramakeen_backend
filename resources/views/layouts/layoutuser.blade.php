...
<nav class="navbar navbar-expand-lg navbar-dark  fixed-top">
           <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <li class="nav-item">
              <form method="get" action="http://127.0.0.1:8000/home">
<br>
                                <input type="hidden" name="_token" value="yD1vkyTIEoFiSir89XcYDtEek4gyUKpxJAFN6MX6">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="contactusu">اتصل بنا </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="talbwasata">طلب وساطة</a>
              </li>

               
                <li class="nav-item">
                    <a class="nav-link" href="hgzu">طلب خدمة</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="servicesu">خدماتنا</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="aboutusu">من نحن</a>

                </li>
                <li class="nav-item">
                    <a class="nav-link" href="homeu" style="color: rgb(206, 180, 117)!important;">الرئيسية</a>
                </li>
...
<section id="map" style="margin-bottom:0px;">
  ...
  <link rel="stylesheet" href="{{asset('assets/js/jquery-3.5.1.js')}}">
